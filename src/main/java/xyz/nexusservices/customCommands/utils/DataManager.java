package xyz.nexusservices.customCommands.utils;
...
import xyz.nexusservices.customCommands.CustomCommands;
...
public class DataManager {
    ...
    public DataManager(CustomCommands plugin, String fileName) {
        this.plugin = plugin;
